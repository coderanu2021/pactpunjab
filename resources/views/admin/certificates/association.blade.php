...
<div class="page-header">
  <div>
    <h1><i class="fa-solid fa-award" style="color:var(--primary);margin-right:8px"></i>Association Certificates</h1>
    <p>View and manage certificates issued to registered associations.</p>
  </div>
...
<div class="stats-grid">
  <div class="stat-card">
    <div class="stat-top">
      ...
      <div class="stat-icon" style="background:var(--primary-soft);color:var(--primary)"><i class="fa-solid fa-award"></i></div>
    </div>
    <div class="stat-footer"><span class="stat-footer-label">Association certificates</span></div>
  </div>
  <div class="stat-card">
    <div class="stat-top">
  ...
  <div class="stat-card">
    ...
    <div class="stat-footer"><span class="stat-footer-label">Past expiry</span></div>
  </div>
</div>
...
<div class="filters-bar">
  <div class="search-box">
    ...
    <input type="text" placeholder="Search by cert ID, association…" id="searchInput" oninput="clientFilter()"/>
  </div>
...
<div class="card">
  <div class="card-header">
    <div>
      <div class="card-title">Association Certificates</div>
      ...
      <tbody id="tableBody">
        ...
        <tr>
          ...
          <td>
            @php
              $cls = 'tag-approved';
              if($item->status == 'Expired' || $item->status == 'Revoked') $cls = 'tag-rejected';
            @endphp
        ...
        @empty
        <tr><td colspan="7" style="text-align:center;padding:40px;color:var(--text-muted)"><i class="fa-solid fa-award" style="font-size:24px;display:block;margin-bottom:8px"></i>No certificates found.</td></tr>
        @endforelse
      </tbody>
    </table>
  </div>
...
<div class="modal-overlay" id="addModal">
  <div class="modal">
    <div class="modal-header">
      <h2><i class="fa-solid fa-award" style="color:var(--primary);margin-right:8px"></i>Issue Association Certificate</h2>
    ...
    <div class="modal-body">
      <form>
        <div class="detail-grid">
          <div class="detail-item"><label>Certificate ID</label><input type="text" class="form-input" placeholder="ACERT-001"/></div>
          <div class="detail-item"><label>Association Name</label><input type="text" class="form-input" placeholder="Association name"/></div>
