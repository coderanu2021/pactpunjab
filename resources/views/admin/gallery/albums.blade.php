...
<div class="page-header">
  <div>
    <h1><i class="fa-solid fa-images" style="color:var(--primary);margin-right:8px"></i>Gallery Albums</h1>
    <p>Manage photo albums and collections for the association gallery.</p>
  </div>
  <div class="header-actions">
    <button class="btn btn-primary" onclick="document.getElementById('addModal').classList.add('open')"><i class="fa-solid fa-plus"></i> Add Album</button>
  </div>
</div>
...
<div class="stats-grid">
  <div class="stat-card">
    <div class="stat-top">
      <div><div class="stat-label">Total Albums</div><div class="stat-value" style="margin-top:8px">{{ $data->total() }}</div></div>
      <div class="stat-icon" style="background:var(--primary-soft);color:var(--primary)"><i class="fa-solid fa-images"></i></div>
    </div>
    <div class="stat-footer"><span class="stat-footer-label">All albums</span></div>
  </div>
  <div class="stat-card">
    <div class="stat-top">
...
<div class="filters-bar">
  <div class="search-box">
    ...
    <input type="text" placeholder="Search albums…" id="searchInput" oninput="clientFilter()"/>
  </div>
  ...
  <div style="overflow-x:auto">
    <table class="data-table" id="mainTable">
      ...
      <tbody id="tableBody">
        ...
        <tr>
          ...
          <td>
            <div style="display:flex;align-items:center;gap:10px">
              <div style="width:36px;height:36px;border-radius:8px;background:var(--primary-soft);color:var(--primary);display:flex;align-items:center;justify-content:center;font-size:16px;flex-shrink:0">
          ...
          <td>
            <div class="action-group">
              <button class="icon-btn view" title="View Images"><i class="fa-solid fa-eye"></i></button>
        ...
        @empty
        <tr><td colspan="5" style="text-align:center;padding:40px;color:var(--text-muted)"><i class="fa-solid fa-images" style="font-size:24px;display:block;margin-bottom:8px"></i>No albums found.</td></tr>
        @endforelse
      </tbody>
    </table>
  </div>
...
<div class="modal-overlay" id="addModal">
  <div class="modal">
    <div class="modal-header">
      <h2><i class="fa-solid fa-images" style="color:var(--primary);margin-right:8px"></i>Add New Album</h2>
    ...
    <div class="modal-body">
      <form>
        <div class="detail-grid">
          <div class="detail-item" style="grid-column:1/-1"><label>Album Title</label><input type="text" class="form-input" placeholder="Album title"/></div>
    ...
    <div class="modal-footer">
      ...
      <button class="btn btn-primary"><i class="fa-solid fa-save"></i> Save Album</button>
    </div>
  </div>
</div>
