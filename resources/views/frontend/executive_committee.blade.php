...
<div class="page-body">
  ...
  <div class="ec-grid" id="ec-grid">
    ...
    <!-- Chandigarh -->
    <div class="ec-card" data-city="chandigarh">
      <div class="ec-avatar" style="background:linear-gradient(140deg,var(--gold),#C47D00)">SW</div>
      <h5>Sanjeev Walia</h5>
      <div class="ec-firm">Walia Computers</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Chandigarh</div>
      <div class="ec-role-tag" style="background:rgba(245,166,35,.12);color:#7A4A00">President</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>

    <div class="ec-card" data-city="ludhiana">
      <div class="ec-avatar" style="background:linear-gradient(140deg,var(--blue2),var(--navy))">RS</div>
      <h5>Rajinder Singh</h5>
      <div class="ec-firm">Singh IT Solutions</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Ludhiana</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.09);color:var(--blue2)">Vice President</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>

    <div class="ec-card" data-city="amritsar">
      <div class="ec-avatar" style="background:linear-gradient(140deg,var(--blue2),var(--navy))">AM</div>
      <h5>Arun Mehta</h5>
      <div class="ec-firm">Mehta Tech</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Amritsar</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.09);color:var(--blue2)">Vice President</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>

    <div class="ec-card" data-city="chandigarh">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#059669,#064E3B)">SK</div>
      <h5>Sunil Kumar</h5>
      <div class="ec-firm">Kumar IT Hub</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Chandigarh</div>
      <div class="ec-role-tag" style="background:rgba(16,140,80,.09);color:#065F46">Secretary General</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>

    <div class="ec-card" data-city="jalandhar">
      <div class="ec-avatar" style="background:linear-gradient(140deg,var(--accent),#8B1A06)">PK</div>
      <h5>Pankaj Kapoor</h5>
      <div class="ec-firm">Kapoor Systems</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Jalandhar</div>
      <div class="ec-role-tag" style="background:rgba(224,58,18,.08);color:var(--accent)">Joint Secretary</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>

    <div class="ec-card" data-city="patiala">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#7C3AED,#2E1065)">RG</div>
      <h5>Rohit Gupta</h5>
      <div class="ec-firm">Gupta Electronics</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Patiala</div>
      <div class="ec-role-tag" style="background:rgba(124,58,237,.09);color:#7C3AED">Treasurer</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>

    <div class="ec-card" data-city="chandigarh">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#0284C7,#0C4A6E)">NB</div>
      <h5>Navdeep Bhatia</h5>
      <div class="ec-firm">Bhatia Computers</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Mohali</div>
      <div class="ec-role-tag" style="background:rgba(14,165,233,.1);color:#0369A1">Joint Treasurer</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>

    <div class="ec-card" data-city="chandigarh">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#D97706,#78350F)">PS</div>
      <h5>Priya Sharma</h5>
      <div class="ec-firm">Sharma Digital</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Chandigarh</div>
      <div class="ec-role-tag" style="background:rgba(217,119,6,.1);color:#92400E">PRO & Media</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>

    <!-- EC Members -->
    <div class="ec-card" data-city="ludhiana">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#1E50A2,#0C2F5E)">VK</div>
      <h5>Vijay Kumar</h5>
      <div class="ec-firm">VK Computers</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Ludhiana</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>

    <div class="ec-card" data-city="amritsar">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#059669,#065F46)">HS</div>
      <h5>Harpreet Singh</h5>
      <div class="ec-firm">HS Tech World</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Amritsar</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>
    ...
    <div class="ec-card" data-city="jalandhar">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#DC2626,#7C1D1D)">MS</div>
      <h5>Manpreet Singh</h5>
      <div class="ec-firm">MS Infosys</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Jalandhar</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>
    ...
    <div class="ec-card" data-city="patiala">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#7C3AED,#4C1D95)">DK</div>
      <h5>Deepak Kumar</h5>
      <div class="ec-firm">DK Technologies</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Patiala</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>
    ...
    <div class="ec-card" data-city="chandigarh">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#0284C7,#075985)">AK</div>
      <h5>Ankur Khurana</h5>
      <div class="ec-firm">Khurana IT</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Chandigarh</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>
    ...
    <div class="ec-card" data-city="ludhiana">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#D97706,#92400E)">SB</div>
      <h5>Sandeep Bajaj</h5>
      <div class="ec-firm">Bajaj Computers</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Ludhiana</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>
    ...
    <div class="ec-card" data-city="amritsar">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#065F46,#022C22)">RV</div>
      <h5>Ravi Verma</h5>
      <div class="ec-firm">Verma Tech Solutions</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Amritsar</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>
    ...
    <div class="ec-card" data-city="jalandhar">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#BE185D,#831843)">NK</div>
      <h5>Neha Kaur</h5>
      <div class="ec-firm">NK Digital</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Jalandhar</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>
    ...
    <div class="ec-card" data-city="patiala">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#1D4ED8,#1E3A8A)">GS</div>
      <h5>Gurpreet Singh</h5>
      <div class="ec-firm">GS Computers</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Patiala</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>
    ...
    <div class="ec-card" data-city="chandigarh">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#B45309,#78350F)">TM</div>
      <h5>Tarun Malhotra</h5>
      <div class="ec-firm">Malhotra IT</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Chandigarh</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>
    ...
    <div class="ec-card" data-city="ludhiana">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#0369A1,#0C4A6E)">AS</div>
      <h5>Arjun Sethi</h5>
      <div class="ec-firm">Sethi Networks</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Ludhiana</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>
    ...
    <div class="ec-card" data-city="amritsar">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#6D28D9,#4C1D95)">SC</div>
      <h5>Sanjay Chadha</h5>
      <div class="ec-firm">Chadha Systems</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Amritsar</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>
    ...
    <div class="ec-card" data-city="jalandhar">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#0F766E,#134E4A)">BP</div>
      <h5>Baldev Pal</h5>
      <div class="ec-firm">Pal Computers</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Jalandhar</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>
    ...
    <div class="ec-card" data-city="patiala">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#DC2626,#991B1B)">KS</div>
      <h5>Kulwinder Singh</h5>
      <div class="ec-firm">KS Tech</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Patiala</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>
    ...
    <div class="ec-card" data-city="chandigarh">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#059669,#047857)">MA</div>
      <h5>Monika Arora</h5>
      <div class="ec-firm">Arora Digital Solutions</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Chandigarh</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>
    ...
    <div class="ec-card" data-city="ludhiana">
      <div class="ec-avatar" style="background:linear-gradient(140deg,#1E50A2,#1A3C6E)">PT</div>
      <h5>Pardeep Taneja</h5>
      <div class="ec-firm">Taneja Electronics</div>
      <div class="ec-city"><i class="fas fa-map-marker-alt"></i> Ludhiana</div>
      <div class="ec-role-tag" style="background:rgba(30,80,162,.07);color:var(--blue2)">EC Member</div>
      <div class="ec-contact"><div class="econ"><i class="fas fa-envelope"></i></div><div class="econ"><i class="fas fa-phone"></i></div></div>
    </div>
